 ...
 */
public class NettyClientHandler extends SimpleChannelInboundHandler<MsgInfo> {
    @Override
    public void userEventTriggered(ChannelHandlerContext ctx, Object evt) throws Exception {
        if (evt instanceof IdleStateEvent) {
            ...
            switch (e.state()) {
                case WRITER_IDLE:
                    MsgInfo heartMsg=new MsgInfo(MsgTypeEnum.HEART.getValue());
    ...
    protected void messageReceived(ChannelHandlerContext channelHandlerContext, MsgInfo msgInfo) throws Exception {
        ...
        switch (msgType){
            //ping
            case 0x00:{
                MsgInfo pingMsg=new MsgInfo(MsgTypeEnum.PING.getValue());
            ...
            //pay
            case 0x03:{
                MsgInfo payMsg=new MsgInfo(MsgTypeEnum.PAY.getValue());
