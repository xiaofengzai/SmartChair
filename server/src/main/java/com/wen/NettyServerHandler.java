...
//     */
//    @Override
//    protected void messageReceived(ChannelHandlerContext channelHandlerContext, MessageInfo messageInfo) throws Exception {
...
//        switch (msgType){
//            case 0x02 :{
//                MessageInfo pingMsg=new MessageInfo(HEART);
...
//            case 0x03:{
//                //收到客户端收款回复
//                MessageInfo payMsg=new MessageInfo(PAY);
